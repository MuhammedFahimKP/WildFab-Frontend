...
const NetworkErrorAlert = ({ toast }: Props) => {
  return (
    <div
      id="toast-success"
      className="flex items-center w-full max-w-xs p-4 mb-4 border border-gray-200  text-gray-500 bg-white rounded-xl  shadow-lg dark:text-gray-400 dark:bg-gray-800"
      role="alert"
    >
