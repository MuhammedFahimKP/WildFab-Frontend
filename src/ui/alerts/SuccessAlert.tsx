...
const SuccessAlert = ({ toast, successText }: Props) => {
  return (
    <div
      id="toast-success"
      className="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-green-50 rounded-xl  shadow-lg border border-green-100   dark:text-gray-400 dark:bg-gray-800"
      role="alert"
    >
      ...
      <div className="ms-3 text-sm font-normal text-teal-500">
        {successText}
      </div>
      <button
        type="button"
